...
const getBaseExponentForBuilding = (code) => {
  switch (code) {
    case GAME_ELEMENTS.METAL_MINE.code:
    case GAME_ELEMENTS.DEUTERIUM_SYNTHESIZER.code:
    case GAME_ELEMENTS.SOLAR_PLANT.code:
      return 1.5;
    case GAME_ELEMENTS.CRYSTAL_MINE.code:
      return 1.6;
    case GAME_ELEMENTS.FUSION_REACTOR.code:
      return 1.8;
    default:
      return 2;
  }
...
export const buildingCostByLevel = (code, level) => {
  ...
  return {
    ...
    deuterium: baseCost.deuterium * multiplier,
    energy: baseCost.energy * level * (1.1 ** level),
  };
}
