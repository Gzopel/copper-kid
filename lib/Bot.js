...
export class Bot {
  ...
  spyAll = (targets, planet, retries = 0) => {
    ...
    if ((this.gameState.ownMissions === this.gameState.maxOwnMissions)
     || (this.gameState.planets[planet].ships[GAME_ELEMENTS.ESPIONAGE_PROBE.code]) < this.spyProbes) {
  ...
  hasAttackingFleet(planet) {
    return (this.gameState.planets[planet].ships[GAME_ELEMENTS.SMALL_CARGO.code] ||
